        ...
        if len(overeni_zacina_cislo) == 0:
            ...
            if len(mackas_vic_znamenek) == 0:
                ...
                if len(pozice) == 0:
                    pozice.append(1)
                znamenko = "+"
                stav.config(text = cislo_prvni + mez + znamenko + mez + cislo_druhe + mez + rovnase + mez + vysledek, font=("Arial", 36))
            else:
                messagebox.showinfo("uz si jednou zmacnul znaminko","uz si jednou zmacnul znaminko, bud dokonci vypocet a nebo vynuluj kalkulacku")
...
krat_tlacitko = Button(okno, width="10", height="5", background="orange", text="x",font=("Arial", 22), command = krat)
#jedna_tlacitko.config()
krat_tlacitko.grid(row=1,column=1)

deleno_tlacitko = Button(okno, width="10", height="5", background="orange", text="/",font=("Arial", 22), command = deleno)
#jedna_tlacitko.config()
deleno_tlacitko.grid(row=5,column=1)


jedna_tlacitko = Button(okno, width="10", height="5", background="orange", text="1",font=("Arial", 22), command = jedna)
#jedna_tlacitko.config()
jedna_tlacitko.grid(row=2,column=1)

dva_tlacitko = Button(okno, width="10", height="5", background="orange", text="2",font=("Arial", 22), command = dva)
#jedna_tlacitko.config()
dva_tlacitko.grid(row=2,column=2)

tri_tlacitko = Button(okno, width="10", height="5", background="orange", text="3",font=("Arial", 22), command = tri)
#jedna_tlacitko.config()
tri_tlacitko.grid(row=2,column=3)

ctyri_tlacitko = Button(okno, width="10", height="5", background="orange", text="4",font=("Arial", 22), command = ctyri)
#jedna_tlacitko.config()
ctyri_tlacitko.grid(row=3,column=1)

sedm_tlacitko = Button(okno, width="10", height="5", background="orange", text="7",font=("Arial", 22), command = sedm)
#jedna_tlacitko.config()
sedm_tlacitko.grid(row=4,column=1)

pet_tlacitko = Button(okno, width="10", height="5", background="orange", text="5",font=("Arial", 22), command = pet)
#jedna_tlacitko.config()
pet_tlacitko.grid(row=3,column=2)

sest_tlacitko = Button(okno, width="10", height="5", background="orange", text="6",font=("Arial", 22), command = sest)
#jedna_tlacitko.config()
sest_tlacitko.grid(row=3,column=3)

devet_tlacitko = Button(okno, width="10", height="5", background="orange", text="9",font=("Arial", 22), command = devet)
#jedna_tlacitko.config()
devet_tlacitko.grid(row=4,column=3)

osm_tlacitko = Button(okno, width="10", height="5", background="orange", text="8",font=("Arial", 22), command = osm)
#jedna_tlacitko.config()
osm_tlacitko.grid(row=4,column=2)

plus_tlacitko = Button(okno, width="10", height="5", background="orange", text="+",font=("Arial", 22), command = plus)
#plus_tlacitko.config()
plus_tlacitko.grid(row=1,column=2)
#plus_tlacitko = Button(okno, width="14", height="6", background="orange")

minus_tlacitko = Button(okno, width="10", height="5", background="orange", text="-",font=("Arial", 22), command = minus)
#minus_tlacitko.config()
minus_tlacitko.grid(row=1,column=3)

vynulovat_tlacitko = Button(okno, width="10", height="5",bg='#ff00c0',highlightbackground='#ff00c0', background="orange", text="vynulovat",font=("Arial", 22), command = vynulovat)
#minus_tlacitko.config()
vynulovat_tlacitko.grid(row=5,column=3)

rovnase_tlacitko = Button(okno, width="10", height="5", background="orange", text="=",font=("Arial", 22), command = rovnase_funkce)
#minus_tlacitko.config()
rovnase_tlacitko.grid(row=5,column=2)

stav = Label(okno, text= cislo_prvni + znamenko + cislo_druhe + rovnase + vysledek, font=("Arial", 36))
stav.grid(row=1,column=4)
